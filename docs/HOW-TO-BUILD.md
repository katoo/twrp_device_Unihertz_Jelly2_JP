...
<manifest>
  ...
  <project name="katoo/twrp_device_Unihertz_Jelly2_JP" path="device/Unihertz/Jelly2_JP" remote="github" revision="master" />
</manifest>
```
...
```bash
# For the Jelly2 JP use
~/android/twrp/device/Unihertz/Jelly2_JP/extract-files.sh ~/unihertz/extracted
```
...
```bash
# For the Jelly2 JP use
~/android/twrp/device/Unihertz/Jelly2_JP/extract-files.sh
```
